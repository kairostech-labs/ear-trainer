...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1350: x0 => x0.createStereoPanner(),
      _1351: (x0,x1) => x0.connect(x1),
      _1352: x0 => x0.load(),
      ...
      _1361: x0 => ({frequency: x0}),
      _1362: x0 => new Accelerometer(x0),
      _1363: x0 => x0.start(),
      ...
      _1370: x0 => new LinearAccelerationSensor(x0),
      _1371: x0 => x0.start(),
      ...
      _1381: (x0,x1) => x0.readAsDataURL(x1),
      ...
      _1390: x0 => new Blob(x0),
      _1391: x0 => globalThis.URL.revokeObjectURL(x0),
      _1392: (x0,x1,x2) => x0.slice(x1,x2),
      _1393: x0 => x0.deviceMemory,
      _1394: x0 => x0.getBattery(),
      _1395: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1395(f,arguments.length,x0) }),
      _1396: () => globalThis.removeSplashFromWeb(),
      _1397: (x0,x1) => x0.appendChild(x1),
      _1398: (x0,x1) => x0.querySelector(x1),
      _1400: (x0,x1) => x0.matchMedia(x1),
      _1402: x0 => x0.pyodide,
      _1405: x0 => x0.webSocketEndpoint,
      _1406: x0 => x0.routeUrlStrategy,
      _1411: x0 => x0.assetsDir,
      _1412: () => globalThis.flet,
      _1413: Date.now,
      ...
      _1432: x0 => new FinalizationRegistry(x0),
      _1433: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1435: (x0,x1) => x0.unregister(x1),
      _1437: () => globalThis.WeakRef,
      _1438: () => globalThis.FinalizationRegistry,
      ...
      _1656: o => o instanceof Array,
      _1657: (a, i) => a.push(i),
      _1658: (a, i) => a.splice(i, 1)[0],
      _1659: (a, i, v) => a.splice(i, 0, v),
      _1661: a => a.pop(),
      _1662: (a, i) => a.splice(i, 1),
      _1664: (a, s, e) => a.slice(s, e),
      _1666: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1667: a => a.length,
      ...
      _1673: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1675: o => o instanceof Uint8Array,
      _1676: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1677: o => o instanceof Int8Array,
      _1678: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1679: o => o instanceof Uint8ClampedArray,
      _1680: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1681: o => o instanceof Uint16Array,
      _1682: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1683: o => o instanceof Int16Array,
      _1684: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1685: o => o instanceof Uint32Array,
      _1686: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1687: o => o instanceof Int32Array,
      _1688: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1690: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1691: o => o instanceof Float32Array,
      _1692: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1693: o => o instanceof Float64Array,
      _1694: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1695: (t, s) => t.set(s),
      _1696: l => new DataView(new ArrayBuffer(l)),
      _1697: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1698: o => o.byteLength,
      _1699: o => o.buffer,
      _1700: o => o.byteOffset,
      _1701: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1702: (b, o) => new DataView(b, o),
      _1703: (b, o, l) => new DataView(b, o, l),
      _1704: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1705: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1706: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1707: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1708: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1709: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1710: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1711: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1712: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1713: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1714: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1715: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1716: Function.prototype.call.bind(DataView.prototype.getBigUint64),
      _1718: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1719: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1720: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1721: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1722: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1723: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1724: Function.prototype.call.bind(Number.prototype.toString),
      _1725: Function.prototype.call.bind(BigInt.prototype.toString),
      _1726: Function.prototype.call.bind(Number.prototype.toString),
      _1727: (d, digits) => d.toFixed(digits),
      _1740: () => globalThis.document,
      _1741: () => globalThis.window,
      _1746: (x0,x1) => { x0.height = x1 },
      _1748: (x0,x1) => { x0.width = x1 },
      _1750: (x0,x1) => { x0.pointerEvents = x1 },
      _1753: x0 => x0.head,
      _1754: x0 => x0.classList,
      _1758: (x0,x1) => { x0.innerText = x1 },
      _1759: x0 => x0.style,
      _1761: x0 => x0.sheet,
      _1762: x0 => x0.src,
      _1763: (x0,x1) => { x0.src = x1 },
      _1764: x0 => x0.naturalWidth,
      _1765: x0 => x0.naturalHeight,
      _1772: x0 => x0.offsetX,
      _1773: x0 => x0.offsetY,
      _1774: x0 => x0.button,
      _1781: x0 => x0.status,
      _1782: (x0,x1) => { x0.responseType = x1 },
      _1784: x0 => x0.response,
      _1833: (x0,x1) => { x0.responseType = x1 },
      _1834: x0 => x0.response,
      _1894: (x0,x1) => { x0.draggable = x1 },
      _1910: x0 => x0.style,
      _2267: (x0,x1) => { x0.target = x1 },
      _2269: (x0,x1) => { x0.download = x1 },
      _2294: (x0,x1) => { x0.href = x1 },
      _2387: (x0,x1) => { x0.src = x1 },
      _2513: x0 => x0.error,
      _2515: (x0,x1) => { x0.src = x1 },
      _2520: (x0,x1) => { x0.crossOrigin = x1 },
      _2523: (x0,x1) => { x0.preload = x1 },
      _2527: x0 => x0.currentTime,
      _2528: (x0,x1) => { x0.currentTime = x1 },
      _2529: x0 => x0.duration,
      _2534: (x0,x1) => { x0.playbackRate = x1 },
      _2543: (x0,x1) => { x0.loop = x1 },
      _2547: (x0,x1) => { x0.volume = x1 },
      _2564: x0 => x0.code,
      _2565: x0 => x0.message,
      ...
      _3675: x0 => x0.screen,
      _3678: x0 => x0.innerHeight,
      _3682: x0 => x0.screenLeft,
      _3686: x0 => x0.outerHeight,
      _3934: x0 => x0.sessionStorage,
      _3935: x0 => x0.localStorage,
      _4036: x0 => x0.clipboard,
      _4044: x0 => x0.maxTouchPoints,
      _4051: x0 => x0.appCodeName,
      _4052: x0 => x0.appName,
      _4053: x0 => x0.appVersion,
      _4054: x0 => x0.platform,
      _4055: x0 => x0.product,
      _4056: x0 => x0.productSub,
      _4057: x0 => x0.userAgent,
      _4058: x0 => x0.vendor,
      _4059: x0 => x0.vendorSub,
      _4061: x0 => x0.language,
      _4062: x0 => x0.languages,
      _4063: x0 => x0.onLine,
      _4068: x0 => x0.hardwareConcurrency,
      _4108: x0 => x0.data,
      _4265: x0 => x0.length,
      ...
      _4498: x0 => x0.code,
      _4499: x0 => x0.reason,
      _5650: x0 => x0.destination,
      _5654: x0 => x0.state,
      _6162: x0 => x0.type,
      _6203: x0 => x0.signal,
      _6264: x0 => x0.firstChild,
      _6275: () => globalThis.document,
      _6357: x0 => x0.body,
      _6359: x0 => x0.head,
      _6686: x0 => x0.id,
      ...
      _11136: (x0,x1) => { x0.display = x1 },
      _11300: (x0,x1) => { x0.height = x1 },
      _11990: (x0,x1) => { x0.width = x1 },
      _12281: x0 => x0.charging,
      _12284: x0 => x0.level,
      _12286: (x0,x1) => { x0.onchargingchange = x1 },
      _12358: x0 => x0.name,
      ...
      _13117: x0 => x0.y,
      _13118: x0 => x0.z,
      _13119: (x0,x1) => { x0.onreading = x1 },
      _13120: (x0,x1) => { x0.onerror = x1 },
      _13121: x0 => x0.error,
      _13122: x0 => x0.name,
      _13123: x0 => x0.message,
      _13128: x0 => globalThis.Wakelock.toggle(x0),
      _13129: () => globalThis.Wakelock.enabled(),
