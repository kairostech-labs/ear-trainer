...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1626: (x0,x1) => new WebSocket(x0,x1),
      _1627: (x0,x1) => x0.send(x1),
      _1628: (x0,x1,x2) => x0.close(x1,x2),
      _1630: x0 => x0.close(),
      _1633: (x0,x1,x2,x3) => ({method: x0,headers: x1,body: x2,credentials: x3}),
      _1634: (x0,x1,x2) => x0.fetch(x1,x2),
      _1635: () => new AbortController(),
      _1636: x0 => x0.abort(),
      _1637: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1638: (x0,x1) => globalThis.fetch(x0,x1),
      _1639: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1639(f,arguments.length,x0,x1,x2) }),
      _1640: (x0,x1) => x0.forEach(x1),
      _1641: x0 => x0.getReader(),
      _1642: x0 => x0.cancel(),
      _1643: x0 => x0.read(),
      _1644: (x0,x1) => x0.key(x1),
      _1645: o => o instanceof Array,
      _1646: (a, i) => a.push(i),
      _1647: (a, i) => a.splice(i, 1)[0],
      _1648: (a, i, v) => a.splice(i, 0, v),
      _1650: a => a.pop(),
      _1651: (a, i) => a.splice(i, 1),
      _1653: (a, s, e) => a.slice(s, e),
      _1655: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1656: a => a.length,
      _1657: (a, l) => a.length = l,
      _1658: (a, i) => a[i],
      _1659: (a, i, v) => a[i] = v,
      _1661: o => {
      ...
      _1662: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1664: o => o instanceof Uint8Array,
      _1665: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1666: o => o instanceof Int8Array,
      _1667: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1668: o => o instanceof Uint8ClampedArray,
      _1669: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1670: o => o instanceof Uint16Array,
      _1671: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1672: o => o instanceof Int16Array,
      _1673: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1674: o => o instanceof Uint32Array,
      _1675: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1676: o => o instanceof Int32Array,
      _1677: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1679: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1680: o => o instanceof Float32Array,
      _1681: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1682: o => o instanceof Float64Array,
      _1683: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1684: (t, s) => t.set(s),
      _1685: l => new DataView(new ArrayBuffer(l)),
      _1686: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1687: o => o.byteLength,
      _1688: o => o.buffer,
      _1689: o => o.byteOffset,
      _1690: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1691: (b, o) => new DataView(b, o),
      _1692: (b, o, l) => new DataView(b, o, l),
      _1693: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1694: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1695: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1696: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1697: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1698: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1699: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1700: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1701: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1702: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1703: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1704: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1705: Function.prototype.call.bind(DataView.prototype.getBigUint64),
      _1707: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1708: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1709: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1710: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1711: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1712: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1713: Function.prototype.call.bind(Number.prototype.toString),
      _1714: Function.prototype.call.bind(BigInt.prototype.toString),
      _1715: Function.prototype.call.bind(Number.prototype.toString),
      _1716: (d, digits) => d.toFixed(digits),
      _1729: () => globalThis.document,
      _1730: () => globalThis.window,
      _1735: (x0,x1) => { x0.height = x1 },
      _1737: (x0,x1) => { x0.width = x1 },
      _1739: (x0,x1) => { x0.pointerEvents = x1 },
      _1742: x0 => x0.head,
      _1743: x0 => x0.classList,
      _1747: (x0,x1) => { x0.innerText = x1 },
      _1748: x0 => x0.style,
      _1750: x0 => x0.sheet,
      _1751: x0 => x0.src,
      ...
      _3135: (x0,x1) => { x0.src = x1 },
      _3137: (x0,x1) => { x0.type = x1 },
      _3141: (x0,x1) => { x0.async = x1 },
      _3155: (x0,x1) => { x0.charset = x1 },
      _3604: () => globalThis.window,
      _3663: x0 => x0.navigator,
      _3667: x0 => x0.screen,
      _3670: x0 => x0.innerHeight,
      _3674: x0 => x0.screenLeft,
      _3678: x0 => x0.outerHeight,
      _3926: x0 => x0.sessionStorage,
      _3927: x0 => x0.localStorage,
      _4028: x0 => x0.clipboard,
      _4036: x0 => x0.maxTouchPoints,
      _4043: x0 => x0.appCodeName,
      _4044: x0 => x0.appName,
      _4045: x0 => x0.appVersion,
      _4046: x0 => x0.platform,
      _4047: x0 => x0.product,
      _4048: x0 => x0.productSub,
      _4049: x0 => x0.userAgent,
      _4050: x0 => x0.vendor,
      _4051: x0 => x0.vendorSub,
      _4053: x0 => x0.language,
      _4054: x0 => x0.languages,
      _4055: x0 => x0.onLine,
      _4060: x0 => x0.hardwareConcurrency,
      _4100: x0 => x0.data,
      _4257: x0 => x0.length,
      _4474: x0 => x0.readyState,
      _4483: x0 => x0.protocol,
      _4487: (x0,x1) => { x0.binaryType = x1 },
      _4490: x0 => x0.code,
      _4491: x0 => x0.reason,
      _6158: x0 => x0.type,
      _6199: x0 => x0.signal,
      _6260: x0 => x0.firstChild,
